-- CreateEnum
CREATE TYPE "public"."ProductSizes" AS ENUM ('SINGLE', 'DOUBLE', 'TRIBLE');

-- CreateEnum
CREATE TYPE "public"."ProductExtra" AS ENUM ('CHEESE', 'BACON', 'TOMATO', 'ONION', 'PEPPER');
...
CREATE TABLE "public"."Extra" (
    "id" TEXT NOT NULL,
    "name" "public"."ProductExtra" NOT NULL,
    "price" DOUBLE PRECISION NOT NULL,
    "productId" TEXT NOT NULL,
