...
const UploadImage = ({
  ...
  return (
    <div className="group mx-auto md:mx-0 relative w-[200px] h-[200px] rounded-full overflow-hidden">
      {selectedImage && (
        <Image
          src={selectedImage}
      ...
      <div
        className={`absolute inset-0 bg-gray-50/40 flex items-center justify-center transition-opacity duration-200 ${
          selectedImage ? "opacity-0 group-hover:opacity-100" : "opacity-100"
        }`}
      >
        <input
          type="file"
